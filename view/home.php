      ...
      <div id="carouselExampleAutoplaying" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img src="../Beauty_E-Commerce/assets/images/skincare3.jpg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="../Beauty_E-Commerce/assets/images/makeup1.jpg" class="d-block w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="../Beauty_E-Commerce/assets/images/makeup2.jpg" class="d-block w-100" alt="...">
          </div>
        </div>
